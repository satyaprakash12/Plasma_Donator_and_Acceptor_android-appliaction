package com.example.plasmabank.adapters;
...
public class SearchDonorAdapter extends RecyclerView.Adapter<SearchDonorAdapter.PostHolder> {
    ...
    {
        TextView Name, Address, contact, posted, totaldonate,Covid;
        ...
        public PostHolder(@NonNull View itemView) {
            ...
            Covid = itemView.findViewById(R.id.inputyasno);
    ...
    public void onBindViewHolder(PostHolder postHolder, int i) {
        ...
        postHolder.Covid.setText("Covid-19 recovered warrior: "+donorData.getCovid());
