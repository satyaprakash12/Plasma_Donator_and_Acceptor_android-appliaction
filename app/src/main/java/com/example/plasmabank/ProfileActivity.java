...
public class ProfileActivity extends AppCompatActivity {
    ...
    private Spinner gender, bloodgroup, division, covid;
...
covid=findViewById(R.id.yesno);
        ...
        if (mAuth.getCurrentUser() != null) {
            ...
            Profile.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    com.example.plasmabank.viewmodels.UserData userData = dataSnapshot.getValue(com.example.plasmabank.viewmodels.UserData.class);
                    ...
                    if (userData != null) {
                        ...
                        covid.setSelection(userData.getCovid());
                        Query donor = donor_ref.child(division.getSelectedItem().toString())
                                .child(covid.getSelectedItem().toString())
                        ...
                        donor.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                {
                                    Toast.makeText(ProfileActivity.this, "Your are not a donor! Be a donor and save life by donating Plasma.",
        ...
        btnSignup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final int Covid= covid.getSelectedItemPosition();
                ...
                final String Covi  =covid.getSelectedItem().toString();
                                        ...
                                        .addOnCompleteListener(ProfileActivity.this, new OnCompleteListener<AuthResult>() {
                                            ...
                                            public void onComplete(@NonNull Task<AuthResult> task) {
                                                ...
                                                if (!task.isSuccessful()) {
                                                    ...
                                                    db_ref.child(id).child("Covid").setValue(Covid);
                                                    ...
                                                    if(isDonor.isChecked())
                                                    {
                                                        ...
                                                        donor_ref.child(div).child(blood).child(id).child("Covid").setValue(Covi);
